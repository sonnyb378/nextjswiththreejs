...
import SceneCuboidCollider from "@/components/scenes/SceneCuboidCollider";
...
export default function CuboidCollider() {
    return (
            ...
            <h1>
                ...
                <div className="text-sm breadcrumbs">
                    <ul>
                        ...
                        <li className='text-orange-500'>CuboidCollider</li>
                    </ul>
                </div>
            </h1>
            <SceneCuboidCollider />
