...
import SceneConvexHullCollider from "@/components/scenes/SceneConvexHullCollider";
            ...
            <h1>
                ...
                <div className="text-sm breadcrumbs">
                    <ul>
                        ...
                        <li className='text-orange-500'>ConvexHullCollider</li>
                    </ul>
                </div>
            </h1>
          <SceneConvexHullCollider />
      </section>
    )
  }
