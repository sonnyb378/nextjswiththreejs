...
import { Environment, OrbitControls, PerspectiveCamera, PresentationControls, ContactShadows, Html } from "@react-three/drei";
...
>
    <MacBookModel />
                            ...
                            <li className="text-yellow-500">Spring Configuration
                                <ul className="w-full text-xs space-y-2 mt-2 list-disc p-2 text-white">
                                    <li>To add spring /  tension effect when dragging
                                        <pre><code className="text-green-400">{`
<PresentationControls 
    global 
    rotation={[0.13, 0.1, 0]}
...
>
    <MacBookModel />
                                    ...
                                    <li>"snap" prop, snaps back the object to its original position when mouse is released</li>
                                </ul>
                            </li>      
                            <li className="text-yellow-500">Adding the HTML from drei
                                <ul className="w-full text-xs space-y-2 mt-2 list-disc p-2 text-white">
                                    <li>Add the "Html" helper from drei inside your laptop component. It should within a mesh (eg: primitive, groups, etc)
                                        <pre><code className="text-green-400">{`
<Html
    transform
    ...
    />
            ...
            <div id="canvas" style={{ width:"100%" }} className="flex items-center justify-center w-full h-full max-h-full border-0 border-yellow-700">
                    ...
                    >
                        ...
                        <ContactShadows position-y={ -1.4 } opacity={ .4 } scale={ 5 } blur={ 2.4 } />
...
export default SceneR3FPortfolio;
